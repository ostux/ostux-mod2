...
if ExtremModeOn then
	TUNING.LASER_DAMAGE = TUNING.SPEAR_DAMAGE * 3
	TUNING.LASER_LIGHT_RADIUS = 6.8
	TUNING.LASER_MAXUSES = 300

	TUNING.KATANA_DAMAGE = TUNING.SPEAR_DAMAGE * 4
	TUNING.KATANA_MAXUSES = 300

	TUNING.OSTUXARMOR = 800
	TUNING.OSTUXARMOR_ABSORPTION = .5
	TUNING.OSTUXARMOR_SPEEDMULTI = 1.9
	TUNING.OSTUXARMOR_SANITY = TUNING.CRAZINESS_SMALL * 1
	TUNING.OSTUXARMOR_HUNGER = 1.5
end
